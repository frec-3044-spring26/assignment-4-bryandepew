...
**Answer 6:**
The residuals meet the assumptions of the linar regression and are normally distributed with the distribution roughly centered around zero. There is a left tail, however.
```{r}
